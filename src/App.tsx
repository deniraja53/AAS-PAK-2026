      ...
      >
        <div className="text-center space-y-3">
          <div className="flex justify-center mb-6">
            <div className="w-16 h-16 border-2 border-cyber-blue flex items-center justify-center rotate-45 cyber-glow-blue">
               <Shield size={32} className="text-cyber-blue -rotate-45" />
            </div>
          </div>
          ...
          <div className="space-y-8 py-4">
            <div className="space-y-2">
              <label className="text-cyber-blue/60 text-[9px] font-bold uppercase tracking-[0.3em] flex items-center gap-2">
                <User size={10} /> Identitas Operator
              </label>
              <CyberInput 
      ...
      <div className="flex flex-col h-screen overflow-hidden">
        ...
        <header className="relative z-10 flex justify-between items-center px-8 py-4 border-b border-cyber-blue/30 bg-black/80 backdrop-blur-sm">
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 border-2 border-cyber-blue flex items-center justify-center rotate-45">
              <div className="w-6 h-6 bg-cyber-pink animate-pulse -rotate-45"></div>
            </div>
            <div>
  ...
  const renderTerminated = () => (
    <div className="min-h-screen bg-cyber-red/10 flex flex-col items-center justify-center p-4">
      ...
      >
        ...
        <div className="space-y-4">
          <GlitchText text="TERMINAL_DIMATIKAN" className="text-5xl md:text-7xl text-cyber-red font-black tracking-tighter" />
