...
export default function App() {
  ...
  const finishExam = async () => {
    ...
    try {
      await transmitResults(session, results);
    } catch (e) {
    ...
    EXAM_DATA.questions.forEach((q) => {
      ...
      if (
        ...
        const normalizedCorrect = q.correctAnswer
          ...
          .split("/")[0]
          .trim()
          .replace(/\s/g, ""); // Extract first part if multiple
    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4 relative">
      <div className="absolute top-10 left-10 opacity-20 pointer-events-none">
        <div className="text-[10px] font-mono tracking-widest leading-tight">
          SYS_AUTH_SERVICE [v.4.1]
          <br />
          LOCAL_DATA_CACHE: SIAP
          <br />
      ...
      >
        <div className="text-center space-y-3">
          ...
          <GlitchText
            text="Exam PAK Online"
            className="text-2xl md:text-3xl text-cyber-blue block font-black italic tracking-widest"
          />
      ...
      >
        <div className="text-center">
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <GlitchText
              text="BRIEFING MISI"
              className="text-4xl text-cyber-blue font-black tracking-tighter"
            />
            <div className="h-px w-12 bg-cyber-blue/30" />
          </div>
          <p className="text-cyber-purple text-[10px] tracking-[0.6em] font-mono uppercase">
        ...
        <CyberCard className="font-mono text-sm leading-relaxed text-cyber-blue/90">
          ...
          >
            <div className="flex gap-6 items-start">
              <div className="w-10 h-10 border border-cyber-pink/40 flex items-center justify-center text-cyber-pink shrink-0">
                01
              </div>
              <p>
                Jalankan objektif dengan integritas maksimal. Ketidaksesuaian
                data adalah pelanggaran protokol.
              </p>
            </div>
            <div className="flex gap-6 items-start">
              <div className="w-10 h-10 border border-cyber-pink/40 flex items-center justify-center text-cyber-pink shrink-0">
              ...
              <p>
                Pertahankan fokus sistem yang konsisten. HUD harus tetap dalam
                status viewport utama.
              </p>
            </div>
            <div className="flex gap-6 items-start">
              <div className="w-10 h-10 border border-cyber-pink/40 flex items-center justify-center text-cyber-pink shrink-0">
              ...
              <p>
                Timeline misi ditetapkan selama{" "}
                <span className="text-cyber-pink font-bold underline underline-offset-4 decoration-cyber-pink/30">
                  90 MENIT STANDAR
                </span>
                .
              </p>
            ...
            <div className="flex gap-6 items-start">
              ...
              <p>
                Algoritma deteksi otomatis aktif. Pelanggaran sistem akan memicu
                penguncian terminal segera.
              </p>
            </div>
  ...
  const renderQuestion = () => {
    ...
    const progress =
      ((currentQuestionIndex + 1) / EXAM_DATA.questions.length) * 100;
      ...
      <div className="flex flex-col h-screen overflow-hidden">
        ...
        <header className="relative z-10 flex justify-between items-center px-8 py-4 border-b border-cyber-blue/30 bg-black/80 backdrop-blur-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-black tracking-widest uppercase italic text-cyber-blue">
                System Examination Interface
              </h1>
              <p className="text-[10px] text-cyber-purple font-mono tracking-[0.2em]">
                AUTHORIZED STUDENT ACCESS ONLY // ID: STU-88291
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-8 items-center">
            <div className="text-right font-mono">
              <div className="text-[10px] text-cyber-blue/60 uppercase">
                Remaining Time
              </div>
              <div
                className={`text-3xl font-bold tracking-tighter ${getTimerColor()}`}
              >
                {formatTime(timeLeft)}
              </div>
            </div>
            ...
            <div className="flex flex-col items-end">
              <span className="px-2 py-0.5 bg-cyber-blue text-bg-dark text-[10px] font-bold mb-1 uppercase tracking-tighter shadow-[0_0_10px_#00f0ff]">
        ...
        <main className="relative z-10 flex flex-1 overflow-hidden p-6 gap-6">
          ...
          <aside className="w-64 hud-border p-4 flex flex-col">
            <div className="text-[11px] font-mono mb-6 flex justify-between">
              <span className="text-cyber-blue/60 tracking-widest">
                NODE_NAVIGATOR
              </span>
              <span className="text-cyber-pink font-bold">
                {String(currentQuestionIndex + 1).padStart(2, "0")}/
                {String(EXAM_DATA.questions.length).padStart(2, "0")}
              </span>
            </div>
            <div className="grid grid-cols-5 gap-2 overflow-y-auto pr-2">
              {EXAM_DATA.questions.map((_, idx) => {
                ...
                const isAnswered =
                  answers[EXAM_DATA.questions[idx].id] !== undefined;
                return (
                  <div
                    key={idx}
                    className={`
                      ...
                      ${
                        isSelected
                          ? "border-cyber-pink bg-cyber-pink/20 text-white shadow-[0_0_10px_#ff00c8]"
                          : isAnswered
                            ? "border-cyber-blue/40 bg-cyber-blue/5 text-cyber-blue"
                            : "border-cyber-blue/10 text-cyber-blue/20"
                      }
                    `}
                  >
            ...
            <div className="mt-auto p-4 border-t border-cyber-blue/10 bg-cyber-blue/5">
              <div className="text-[9px] text-cyber-purple font-mono mb-2 tracking-tighter uppercase">
                Packet Transmission Status:{" "}
                {Math.round(
                  (Object.keys(answers).length / EXAM_DATA.questions.length) *
                    100,
                )}
                %
              </div>
              <div className="w-full h-1 bg-cyber-purple/20 rounded-full overflow-hidden">
                <motion.div
                  ...
                  initial={{ width: 0 }}
                  animate={{
                    width: `${(Object.keys(answers).length / EXAM_DATA.questions.length) * 100}%`,
                  }}
                />
              </div>
            </div>
                  ...
                  <div className="space-y-4">
                        ...
                        {q.options.map((option, idx) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <span
                                className={`text-xl font-medium ${isSelected ? "text-white" : "text-cyber-blue/80"}`}
                              >
                                {option.substring(2)}
                              </span>
                              {isSelected && (
                      ...
                      <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                          ...
                          <div className="space-y-3">
                            <label className="text-cyber-pink text-[9px] font-bold uppercase tracking-[0.4em]">
                              Connect Target Node
                            </label>
                            <select
                              value={answers[q.id] || ""}
                            ...
                            >
                              ...
                              {(
                                q.matchingOptions ||
                                EXAM_DATA.questions.find(
                                  (x) =>
                                    x.type === QuestionType.MATCHING &&
                                    x.matchingOptions,
                                )?.matchingOptions
                              )?.map((opt, i) => (
                    ...
                    {q.type === QuestionType.FILL_IN && (
                      <div className="max-w-xl">
                        <p className="text-[9px] text-cyber-purple uppercase tracking-[0.4em] mb-4">
                    ...
                    {q.type === QuestionType.ESSAY && (
                      <div className="space-y-4">
                        <p className="text-[9px] text-cyber-purple uppercase tracking-[0.4em]">
                          Initialize Buffer Storage for Transmission...
                        </p>
                        <CyberTextArea
                        ...
                        <div className="flex justify-end pr-4">
                          <span className="text-[9px] text-cyber-blue/40 uppercase font-mono tracking-widest">
                            Buffer Occupancy: {answers[q.id]?.length || 0}{" "}
                            characters
                          </span>
                        </div>
                      </div>
          ...
          <aside className="w-48 hud-border p-4 text-[9px] font-mono flex flex-col">
            ...
            <div className="space-y-4 overflow-y-auto pr-1 flex-1">
              ...
              {violations.map((v, i) => (
                <div
                  key={i}
                  className="border-l-2 border-cyber-red pl-3 py-1 animate-pulse"
                >
              ...
              {Object.keys(answers).length > 0 && (
                <div className="border-l-2 border-cyber-purple pl-3 py-1">
                  <div className="text-cyber-purple/60 tracking-tighter">
                    DATA PACKET {Object.keys(answers).length} STORED
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="mt-12 opacity-30 space-y-2 border-t border-cyber-blue/10 pt-4">
              ...
              <div className="text-xs tracking-[-0.2em] font-black text-center mt-2 opacity-50">
                \\\\\\\\\\\\\\\\\\\\\\\\\\\\
              </div>
            </div>
          </aside>
          ...
          {showConfirmFinish && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
              <motion.div
                ...
                onClick={() => !isTransmitting && setShowConfirmFinish(false)}
              />
              <motion.div
              ...
              >
                <CyberCard title="KONFIRMASI TRANSMISI">
                  <div className="space-y-6 py-4">
                    <div className="flex gap-4 items-start text-cyber-yellow">
                      <AlertCircle size={24} className="shrink-0" />
                      <p className="text-sm font-mono leading-relaxed">
                        Anda akan melakukan transmisi data akhir ke server
                        pusat. Setelah dikirim, data tidak dapat diubah kembali.
                        Pastikan semua node jawaban telah terisi dengan benar.
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <CyberButton
                        ...
                        disabled={isTransmitting}
                      >
                        {isTransmitting ? "Transmitting..." : "Kirim Sekarang"}
                      </CyberButton>
                    </div>
                  </div>
                </CyberCard>
          ...
          <div className="flex whitespace-nowrap animate-marquee">
            ...
            {[1, 2].map((i) => (
              <div key={i} className="flex items-center gap-10 px-10">
                ...
                <span className="text-cyber-purple font-mono text-[9px]">
                  CYBER_ED MISSION_TERMINAL v2.04
                </span>
      ...
      <div className="min-h-screen p-4 md:p-8 flex flex-col items-center justify-center space-y-16 max-w-6xl mx-auto relative">
        <div className="absolute top-10 right-10 flex flex-col items-end opacity-20 pointer-events-none text-right font-mono text-[9px] tracking-widest gap-2">
          ...
          <div className="flex gap-1 justify-end mt-2">
            <div className="w-4 h-1 bg-cyber-pink" />
            <div className="w-2 h-1 bg-cyber-pink/40" />
          </div>
        </div>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <GlitchText
              text="MISI SELESAI"
              className="text-4xl md:text-6xl text-cyber-blue font-black tracking-tighter"
            />
            <div className="w-2 h-2 bg-cyber-blue rotate-45" />
          </div>
          <p className="text-cyber-purple tracking-[0.8em] font-mono uppercase text-[10px]">
            Menyinkronkan Data Terminal...
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          <CyberCard
            title="DATA_OPERATOR"
            className="md:col-span-1 border-cyber-blue/20"
          >
            <div className="space-y-6 font-mono text-xs py-4">
              <div className="border-l border-cyber-blue/30 pl-4">
                <p className="text-cyber-blue/40 text-[9px] uppercase tracking-widest mb-1">
                  Identitas
                </p>
          ...
          <CyberCard title="LAPORAN_ANALITIK" className="md:col-span-2">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center py-4">
              <div className="space-y-2 group">
                <p className="text-cyber-pink text-5xl font-black drop-shadow-[0_0_10px_#ff00c8]">
                  {results.score}
                </p>
                <p className="text-[9px] text-cyber-blue/60 uppercase font-black tracking-widest">
                  Efisiensi
                </p>
              </div>
              <div className="space-y-2">
                <p className="text-green-400 text-5xl font-black drop-shadow-[0_0_10px_rgba(74,222,128,0.3)]">
              ...
              <div className="space-y-2">
                <p className="text-cyber-red text-5xl font-black drop-shadow-[0_0_10px_rgba(255,0,60,0.3)]">
                  {results.wrongCount}
                </p>
                <p className="text-[9px] text-cyber-blue/60 uppercase font-black tracking-widest">
                  Kesalahan
              ...
              <div className="space-y-2">
                <p className="text-cyber-purple text-5xl font-black drop-shadow-[0_0_10px_rgba(157,0,255,0.3)]">
                  {results.violations}
                </p>
                <p className="text-[9px] text-cyber-blue/60 uppercase font-black tracking-widest">
                  Pelanggaran
            ...
            <div className="mt-10 p-6 bg-[#00f0ff]/5 border border-cyber-blue/20 rounded-none flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-cyber-blue font-mono font-black text-[10px] tracking-widest uppercase">
                    Status Enkripsi: Terverifikasi
                  </p>
                  <p className="text-cyber-blue/60 font-mono text-[9px]">
                    UPLINK STABIL // DATA_PACKET_CHECKSUM: OK
                  </p>
                </div>
              </div>
              <div className="text-cyber-blue/20 rotate-90 scale-150 font-black">
                HUD
              </div>
            </div>
          </CyberCard>
        ...
        <div className="flex flex-col md:flex-row gap-4 mt-8">
          ...
          <CyberButton
            ...
            onClick={() => {
              ...
              a.href = url;
              a.download = `HASIL_${student.name.replace(/\s+/g, "_")}.json`;
              a.click();
              URL.revokeObjectURL(url);
            }}
            className="h-14 px-10"
          >
            <Download size={18} className="mr-2" /> Download Log
          </CyberButton>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-cyber-red/10 flex flex-col items-center justify-center p-4">
      ...
      >
        ...
        <div className="space-y-4">
          <GlitchText
            text="PELANGGARAN"
            className="text-5xl md:text-7xl text-cyber-red font-black tracking-tighter"
          />
        ...
        <CyberCard
          title="LAPORAN_PELANGGARAN"
          className="border-cyber-red/40 bg-cyber-red/5"
        >
          <div className="space-y-4 text-cyber-red font-mono text-xs text-left py-2">
            ...
            <p className="text-[10px] leading-relaxed opacity-60 mt-4 italic">
              Diagnostik akhir: Semua paket data telah dibuang. Diperlukan
              re-otorisasi melalui administrator pusat.
            </p>
          </div>
        </CyberCard>
  ...
  return (
    <div className="relative font-orbitron" ref={examContainerRef}>
      ...
      <div
        className={`fixed inset-0 pointer-events-none transition-colors duration-500 z-[999] ${flashing ? "bg-cyber-red/30" : "bg-transparent"}`}
      />
